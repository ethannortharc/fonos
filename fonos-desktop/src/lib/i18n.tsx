...
const en = {
  ...
  "ob.playground.hint": "Hold your dictation hotkey and speak — your words appear here.",
  ...
  "ob.guided.desc": "Switch to any other app, hold the hotkey, and speak.",
...
const zh: Partial<Record<Key, string>> = {
  ...
  "ob.playground.hint": "按住听写热键说话——文字会出现在这里。",
  ...
  "ob.guided.desc": "切换到任何其他应用，按住热键说话。",
