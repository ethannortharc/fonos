...
echo "    \"$LATEST_JSON\""
echo ""
echo "Then publish the release (CI creates it as a draft so it isn't public"
echo "while only Linux assets exist; publishing once all platforms' assets are"
echo "uploaded is what makes the updater endpoint releases/latest/download serve it):"
echo ""
