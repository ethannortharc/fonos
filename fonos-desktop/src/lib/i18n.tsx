...
const en = {
  ...
  "ob.playground.privacy": "Release to stop. Audio is processed on this Mac when on-device recognition is available — otherwise Apple's speech service is used.",
  "ob.playground.privacy-linux": "Release to stop. Audio is sent to the speech engine you configured.",
  ...
  "ob.playground.ready-linux": "✓ Speech recognition is working",
  ...
  "ob.play.preparing": "Preparing the speech engine…",
  "ob.play.error": "Recording failed: {msg}",
  ...
  "wb.bench.status-emptyinput": "No text selected.",
...
const zh: Partial<Record<Key, string>> = {
  ...
  "ob.playground.privacy": "松开即停。音频优先在本机处理；本机识别不可用时会使用 Apple 语音服务。",
  "ob.playground.privacy-linux": "松开即停。音频会发送到你配置的语音引擎。",
  "ob.playground.hint": "按住 {hotkey} 说话——文字会出现在这里。",
  "ob.playground.ready": "✓ 内置语音识别，无需下载",
  "ob.playground.ready-linux": "✓ 语音识别已就绪",
  ...
  "ob.play.preparing": "正在准备语音引擎…",
  "ob.play.error": "录音失败：{msg}",
  ...
  "wb.bench.status-emptyinput": "未选中文本。",
